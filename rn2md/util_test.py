...
class ParseDatesTest(unittest.TestCase):
    ...
    def testToday(self):
        self.assertListEqual(
            util.ParseDates('today'), [StrToDate('Mar 24th, 2018')])

    @freezegun.freeze_time('Mar 23rd, 2018 12pm')
    def testThisWeek(self):
        self.assertListEqual(
            util.ParseDates('this week'),
            [StrToDate('Mon Mar 19th, 2018'), StrToDate('Tue Mar 20th, 2018'),
             StrToDate('Wed Mar 21st, 2018'), StrToDate('Thu Mar 22nd, 2018'),
             StrToDate('Fri Mar 23rd, 2018'), StrToDate('Sat Mar 24th, 2018'),
             StrToDate('Sun Mar 25th, 2018')])

    @freezegun.freeze_time('Mon Mar 26th, 2018 12pm')
    def testLastWeek(self):
        self.assertListEqual(
            util.ParseDates('last week'),
            [StrToDate('Mon Mar 19th, 2018'), StrToDate('Tue Mar 20th, 2018'),
             StrToDate('Wed Mar 21st, 2018'), StrToDate('Thu Mar 22nd, 2018'),
             StrToDate('Fri Mar 23rd, 2018'), StrToDate('Sat Mar 24th, 2018'),
             StrToDate('Sun Mar 25th, 2018')])
    ...
    def testTodayOnSaturdayRoundsToFridayInWorkdaysOnlyMode(self):
        self.assertListEqual(
            util.ParseDates('today', workdays_only=True),
    ...
    def testWorkWeekReturnedInWorkdayOnlyMode(self):
        self.assertListEqual(
            util.ParseDates('this week', workdays_only=True),
            [StrToDate('Mon Mar 19th, 2018'), StrToDate('Tue Mar 20th, 2018'),
             StrToDate('Wed Mar 21st, 2018'), StrToDate('Thu Mar 22nd, 2018'),
             StrToDate('Fri Mar 23rd, 2018')])
    ...
    def testYesterdayOnSundayReturnsFridayInWorkdaysOnlyMode(self):
        self.assertListEqual(
            ...
            util.ParseDates('yesterday', workdays_only=True))
    ...
    def testTomorrowOnFridayReturnsMondayInWorkdaysOnlyMode(self):
        self.assertListEqual(
            ...
            util.ParseDates('tomorrow', workdays_only=True))
